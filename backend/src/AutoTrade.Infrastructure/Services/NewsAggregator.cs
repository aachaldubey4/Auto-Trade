    ...
    private static Dictionary<string, RSSFeedConfig> LoadFeedConfigurations(IConfiguration configuration)
    {
        ...
        var defaultFeeds = new[]
        {
            ...
            new RSSFeedConfig
            {
                ...
                Enabled = false, // Cloudflare blocks server-side fetches (403). Re-enable behind a proxy.
                FetchInterval = 5,
                Priority = 5
            },
            new RSSFeedConfig
            {
                ...
                Enabled = false, // Returns 403 to server-side fetches. Re-enable behind a proxy.
                FetchInterval = 5,
                Priority = 5
            }
        };
