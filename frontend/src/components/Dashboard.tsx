    ...
    <div className="min-h-screen bg-base-100">
      ...
      <div className="container mx-auto p-2 sm:p-4">
        <div role="tablist" className="tabs tabs-border mb-6">
          <button
            role="tab"
            className={`tab px-8 text-sm ${activeTab === 'dashboard' ? 'tab-active font-bold text-primary border-primary' : 'text-base-content/70'}`}
          ...
          <button
            role="tab"
            className={`tab px-8 text-sm ${activeTab === 'news' ? 'tab-active font-bold text-primary border-primary' : 'text-base-content/70'}`}
